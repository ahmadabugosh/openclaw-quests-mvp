...
export function DiscordHelp() {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 no-print">
      {isExpanded ? (
        <div className="rounded-2xl border-2 border-purple-500/50 bg-gradient-to-br from-purple-900/95 to-slate-900/95 backdrop-blur-sm p-6 shadow-2xl shadow-purple-500/20 animate-in fade-in slide-in-from-bottom-4 duration-200 w-80">
          <button
          ...
          <div className="text-center">
            ...
            <a
              href="https://discord.com/invite/aCenMdqYRp"
              target="_blank"
              rel="noreferrer"
              className="block w-full rounded-lg bg-[#5865F2] hover:bg-[#4752C4] px-6 py-3 font-bold text-white transition-colors"
            >
